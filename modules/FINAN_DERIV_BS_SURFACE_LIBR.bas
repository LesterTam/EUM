...
TEMP_GROUP = MATRIX_GROUP_FUNC(PUB_TENOR_ARR, TEMP2_ARR, 2)
...
For i = 1 To UBound(PUB_STRIKE_ARR, 1)
    ...
    TEMP2_ARR(i, 2) = PUB_IMPL_SIGMA_ARR(i)
Next i
TEMP_GROUP = MATRIX_GROUP_FUNC(PUB_STRIKE_ARR, TEMP2_ARR, 2)
...
XDATA_GROUP_ARR = MATRIX_GROUP_FUNC(PUB_TENOR_ARR, TEMP_MATRIX, 0)
...
XDATA_GROUP_ARR = MATRIX_GROUP_FUNC(PUB_STRIKE_ARR, TEMP_MATRIX, 0)
