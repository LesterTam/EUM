...
Function INTERNET_COMPANIES_SIMULATION_FUNC(ByRef REVENUES_RNG As Variant, _
...
'************************************************************************************
'************************************************************************************
'FUNCTION      : REVENUE_SIMULATION_FUNC
...
Function REVENUE_SIMULATION_FUNC(ByVal nLOOPS As Long, _
ByVal TENOR As Double, _
...
Select Case OUTPUT
Case 0
    REVENUE_SIMULATION_FUNC = DATA_MATRIX
Case Else
    REVENUE_SIMULATION_FUNC = TEMP_MATRIX
End Select

Exit Function
ERROR_LABEL:
REVENUE_SIMULATION_FUNC = Err.number
End Function
