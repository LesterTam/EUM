Attribute VB_Name = "VB_DEPENDENCIES"
...
'Dim i As Long: Dim TEMP_ARR As Variant
'TEMP_ARR = PROCEDURE_DEPENDENTS_FUNC("MATRIX_TRANSPOSE_FUNC", True, "_FUNC")
'For i = LBound(TEMP_ARR) To UBound(TEMP_ARR): Debug.Print TEMP_ARR(i): Next i
